...
MIN_DISTANCE_METERS_YEAR = 50  # минимальное расстояние между точками в метрах для карты 2026
MIN_DISTANCE_METERS_14 = 10  # минимальное расстояние между точками в метрах для карты 2 нед
